...
我试图提供一个适宜而完备的Python学习框架，试图解决一些新手常见的问题， 即“如何学Python？”“重点学啥？”“学习过程中会遇到哪些坑？怎么解决？”
...
- [Python 笔记与源码阅读目录](https://lamirs.vercel.app/python-learning)

## 学习书籍

学习Python基础知识，可供选择的书很多，但它们大都有着一个缺点，那就是内容庞杂，有些内容脱离实际，甚至过时。
